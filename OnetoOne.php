...
$s_id = "";
$u_id = $_COOKIE['id'];
// Get the seller ID and car ID from the POST request
...
<head>
    ...
    <title>Piston Cult Chat</title>
    <link rel="stylesheet" href="assets/style/onetoone.css">
...
?>
        ...
        <div class="content-area">
            <div class="channels-sidebar">
                <div id="channels-container" class="channels-container">
                    <div class="loading" id="loading-indicator">Loading channels...</div>
                </div>
            </div>
    ...
    <script>
        ...
        const SENDER_USER_ID = "<?php echo $u_id; ?>";
        const RECEIVER_USER_ID = "<?php echo $s_id; ?>"; // Assuming car_id is the receiver's ID
    </script>
    <script src="assets/js/onetoone.js"></script>
</body>
</html>