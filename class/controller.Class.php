...
class Connect extends PDO{
    public function __construct(){
        parent::__construct("mysql:host=localhost;dbname=piston_cult", 'root','',
...
class Controller{
    ...
    function insertData($data){
        ...
        if(!$info['ID_USER']){
            ...
            $insertUser = $db->prepare("INSERT INTO user (Username, Avatar, Email, Password, Session, Date) VALUES (:f_name, :Avatar, :Email, :Password, :Session, CURDATE())");
            $insertUser -> execute([
            ...
            if($insertUser){
                ...
                setcookie("un", $un, time()+60*60*24*30, "/", NULL);
